<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSQLData.aspx.cs" Inherits="WFFM8.To.SQL.Presentation.ViewSQLData" %>
            ...
            <section class="col-md-9 sc-applicationContent-main">
                <div data-sc-id="Main" class="sc-border sc-show-padding sc_Border_98 data-sc-registered">
                    ...
                    <table class="sc-table sc-table-header table">
                        <thead>
                            <tr>
                                <asp:Repeater ID="rptHeaderFormData" runat="server" OnItemDataBound="rptHeaderFormData_ItemDataBound">
                                    <ItemTemplate>
                                        <th class="sc-text-align-left sc-table-head">
                                            <div runat="server" id="divHeader" class="sc-table-header-container">
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptFormData" runat="server" OnItemDataBound="rptFormData_ItemDataBound">
                                <ItemTemplate>
